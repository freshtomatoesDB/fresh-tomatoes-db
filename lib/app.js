...
app.get('/api/actors/:id', async(req, res, next) => {
  try {
    const response = await Actor.findActorById(req.params.id);
    res.send(response);
  } catch(error) {
    next(error);
  }
...
app.get('/api/actorsinmovie/:id', async(req, res, next) => {
  try {
    const response = await Actor.findActorByMovieId(req.params.id);
    res.send(response);
  } catch(error) {
    next(error);
  }
...
app.put('/api/actors/:id', async(req, res, next) => {
  try {
    const response = await Actor.updateActor(req.params.id, req.body);
    res.send(response);
  } catch(error) {
    next(error);
  }
...
app.delete('/api/actors/:id', async(req, res, next) => {
  try {
    const response = await Actor.deleteActor(req.params.id);
    res.send(response);
  } catch(error) {
    next(error);
  }
